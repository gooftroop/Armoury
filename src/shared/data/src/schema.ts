...
import { accountsTable, accountsSqliteTable } from '@data/dao/AccountDAO.js';
import { campaignParticipantsTable, campaignParticipantsSqliteTable } from '@data/dao/CampaignParticipantDAO.js';
import { campaignsTable, campaignsSqliteTable } from '@data/dao/CampaignDAO.js';
import { friendsTable, friendsSqliteTable } from '@data/dao/FriendDAO.js';
import { matchesTable, matchesSqliteTable } from '@data/dao/MatchDAO.js';
import { syncStatusTable, syncStatusSqliteTable } from '@data/dao/SyncStatusTable.js';
import { userPresenceTable, userPresenceSqliteTable } from '@data/dao/UserPresenceDAO.js';

import type { SQLiteSchemaExtension, DSQLSchemaExtension, SchemaExtension } from '@data/types.js';

// Re-export schema interfaces for backward compatibility with existing '@data/schema.js' imports
export type { SQLiteSchemaExtension, DSQLSchemaExtension, SchemaExtension } from '@data/types.js';

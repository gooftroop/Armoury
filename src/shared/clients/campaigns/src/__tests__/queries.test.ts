...
import type { CampaignParams, ParticipantParams } from '@/types.js';
...
import { buildQueryCampaignsKey, queryCampaigns } from '@/queries/queryCampaigns.js';
import { buildQueryCampaignKey, queryCampaign } from '@/queries/queryCampaign.js';
import { buildQueryParticipantsKey, queryParticipants } from '@/queries/queryParticipants.js';
import { buildQueryParticipantKey, queryParticipant } from '@/queries/queryParticipant.js';

...
/** DAO for Iron Hands faction data (Space Marines chapter). */
export class IronHandsDAO extends SpaceMarinesDAO {
    private readonly chapterFactionDAO: FactionDAO;

    /** Creates an Iron Hands DAO instance. */
    constructor(adapter: DatabaseAdapter, githubClient: IGitHubClient) {
        super(adapter, githubClient);
        this.chapterFactionDAO = new FactionDAO(adapter, githubClient, FACTION_MAP['iron-hands']);
    }

    /** Loads Iron Hands faction data merged with Space Marines base data. */
    ...
    /** Forces a re-sync of Iron Hands data and merges with Space Marines base data. */

...
/** DAO for Ultramarines faction data (Space Marines chapter). */
export class UltramarinesDAO extends SpaceMarinesDAO {
    private readonly chapterFactionDAO: FactionDAO;

    /** Creates an Ultramarines DAO instance. */
    constructor(adapter: DatabaseAdapter, githubClient: IGitHubClient) {
        super(adapter, githubClient);
        this.chapterFactionDAO = new FactionDAO(adapter, githubClient, FACTION_MAP['ultramarines']);
    }

    /** Loads Ultramarines faction data merged with Space Marines base data. */
    ...
    /** Forces a re-sync of Ultramarines data and merges with Space Marines base data. */
